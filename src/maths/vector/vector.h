...
namespace Vectorable
{
    class Vector
    {
        public:
             ...
             * be passed in manually as second parameter due to the
             * array C++ primitive not knowing it's length once passed
             * to a function.
             */
            Vector(double array[], int noOfArrayElements);

            /**
             * Creates a new vector using the parameters as vector
             * points.
             */
            ...
            /**
             * Returns the scalar/dot product of a vector with another
             * vector.
             */
            ...
            /**
             * Returns a new vector forming from the addition of this
...
/**
 * Allows the vector to be printed to cout directly
 * as an object with toString() needing to be called.
 */
